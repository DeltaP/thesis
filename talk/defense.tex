...
\begin{document}
  ...
  \begin{frame}
    ...
    \centering
    \includegraphics[width=0.7\textwidth]{fig/higgs_collage.png}
  \end{frame}
  ...
  \begin{frame}
    \frametitle{Lattice Studies}
    \centering
    \includegraphics[width=0.9\textwidth]{fig/EthanRM.pdf}
  \end{frame}
  ...
  \begin{frame}
    ...
    \begin{columns}
      \begin{column}{0.7\textwidth}
        \includegraphics[width=1.2\textwidth]{fig/wflow_fixed_beta.png}
      \end{column}
      \begin{column}{0.3\textwidth}
        \begin{centering}
          \vspace{24pt}
